...
static int videobuf_dma_init_user_locked(struct videobuf_dmabuf *dma,
			int direction, unsigned long data, unsigned long size, int *cpu)
#else
static int videobuf_dma_init_user_locked(struct videobuf_dmabuf *dma,
			   ...
			   unsigned long data, unsigned long size)
{
	...
	ret = videobuf_dma_init_user_locked(dma, direction, data, size, &cpu);
